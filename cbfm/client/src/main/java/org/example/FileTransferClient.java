...
public class FileTransferClient extends Socket {
     ...
     * @throws Exception
     */
    public FileTransferClient(String Client_IP,String Client_Port) throws Exception {
    ...
    public String recvFile(String url) throws Exception {
        ...
        try{
            ...
            //String basePath = "/home/simba/gopath/src/github.com/hyperledger/fabric/scripts/fabric-samples/fabsystem/fabsystem-golang";
            String basePath = ClientApp.path+"data";
            String userFolder = url.split("/")[url.split("/").length-2];
            String fileName = url.split("/")[url.split("/").length-1];
            String userPath = basePath + File.separatorChar + userFolder;
            //System.out.println(userPath);
            uniqueFileName = basePath + File.separatorChar + userFolder + File.separatorChar + fileName;
            ...
            File downloadedFile = new File(uniqueFileName);
            ...
            //System.out.println(Utils.readFile(uniqueFileName));
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
        if(fis != null)
    ...
    public void recvCert(String username) throws Exception {
        ...
        String basePath = ClientApp.path+"wallet/"+username;
        String userFilePath = ClientApp.path+"wallet/"+username+"/"+username;
        String userPrivFilePath = userFilePath+"-priv";

        String walletPath = ClientApp.path+"wallet/";
